...
{$IFDEF LANGUAGE_PL}
  ...
  titleScrollLines: array [0 .. 35] of string = ('POMYS£ NA GRÊ', 'GRZEGORZ DROZD', '', '', '', 'PROGRAM', 'GRZEGORZ DROZD',
...
{$ELSE IF LANGUAGE_EN}
  ...
  STR_MISSION_RESCUE_PEOPLE = 'MISSION:'#13'RESCUE SURVIVORS';
  STR_MISSION_DESTROY_ENEMY = 'MISSION:'#13'DESTROY ENEMY TURRETS';
