...
{$ELSE IF LANGUAGE_EN}
  ...
  STR_PRESS_KEY_TO_SETTINGS = 'PRESS [%s] FOR SETTINGS SCREEN';
  ...
  STR_TITLE_NEW_GAME_NORMAL = 'NEW STANDARD GAME: MISSION: %d';
  STR_TITLE_NEW_GAME_RANDOM = 'NEW RANDOM GAME: MISSION: %d';
  ...
  STR_TITLE_ST_SETTINGS = 'GAME SETTINGS';
  STR_TITLE_ST_SFX_VOLUME = 'SOUND EFFECTS VOLUME: %d';
  STR_TITLE_ST_MUSIC_VOLUME = 'MUSIC VOLUME: %d';
  STR_TITLE_ST_BRIGHTNESS = 'BRIGHTNESS: %d';
  STR_TITLE_ST_RETURN_TO_TITLE = '[ESC] BACK TO TITLE SCREEN';
  STR_TITLE_ST_RETURN_TO_GAME = '[ESC] BACK TO GAME';
