...
begin
  ...
  case gra.rodzajmisji of
    0:
      begin
        ...
        pisz2d('zginÍ≥o:' + inttostr(gra.zginelo), currentScreenParams.HudWidth - 10, height - 40, 4, 2);
      end;
    1:
      begin
  ...
  begin
    ...
    pisz2d('PODNIEå L•DOWNIK I LE∆ W D”£, POD STATEK-MATK ', width div 2, height - 90, 5, 1);
  end;
