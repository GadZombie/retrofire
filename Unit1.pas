...
begin
  ...
  try
    try
      ...
      for a := 0 to 49 do
        f.ReadBuffer(klawisze[a], sizeof(klawisze[a]));
      ...
      MessageBox(Handle, pchar('Brak pliku konfiguracji lub jest w nim b³¹d! Uruchom konfiguracjê gry!'), 'B³¹d',
...
begin
  ...
  begin
    MessageBox(Handle, pchar('Blad przy inicjalizacji dzwieku!'#13#10 + FMOD_ErrorString(FSOUND_GetError())), 'Blad!',
